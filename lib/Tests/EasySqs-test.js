...
var testGroup = {
    ...
    "Can get a single message from queue": function (test) {
        ...
        gently.expect(client, "receiveMessage", function (params, callback) {
            var res = {
                Messages: ["one"]
            };
    ...
    "Can put a single message onto a queue": function (test) {
        ...
        gently.expect(client, "sendMessage", function (params, callback) {
            test.equal(params.QueueUrl, "myQueue");
    ...
    "Can delete a message from the queue": function (test) {
        ...
        gently.expect(client, "deleteMessage", function (params, callback) {
